...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def open_realsense(self):
        ...
        # 第二台设备
        serials = ['251622064449', '249322060618', '251622064877', '251622063969', '251622064534']
        ...
        # # # 关闭自动曝光，设置固定曝光参数
        # # auto_exposure
        # sensor1.set_option(rs.option.auto_exposure_priority, True)
        # print(sensor1.get_option(rs.option.exposure))  # 166.0
        # sensor1.set_option(rs.option.exposure, 5000.000)
        # print(sensor1.get_option(rs.option.exposure))  # 5000.0
                ...
                if (self.takePhotos == True):
                    ...
                    if (os.path.isdir(now_date)):
                        ...
                        if re.match('^[\u4E00-\u9FA5a-zA-Z0-9_]*$', self.user_id):
                            ...
                            depth_full_path4 = os.path.join(dir_str, now_time + '_depth_3.png')
                            color_full_path4 = os.path.join(dir_str, now_time + '_color_3.png')
                            depth_full_path5 = os.path.join(dir_str, now_time + '_depth_4.png')
                            color_full_path5 = os.path.join(dir_str, now_time + '_color_4.png')
